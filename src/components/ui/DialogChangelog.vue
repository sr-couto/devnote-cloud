...
<template>
  <DialogRoot>
    ...
    <DialogPortal>
      <DialogOverlay class="bg-background/95 fixed inset-0 z-[9998]" />
      <DialogContent
        class="font-mono fixed top-6 md:top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[750px] translate-x-[-50%] md:translate-y-[-50%] bg-background rounded p-4 focus:outline-none z-[9999]"
      >
          ...
          <ScrollAreaViewport class="w-full h-full">
            <article class="max-w-full p-3 mx-auto prose dark:prose-invert">
              ...
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>
                  Refactor: Se agrega la posibilidad de limpiar la base de datos desde la
                  configuración.
                </li>
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.1.2</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.1.1</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>
                  Feature: Cuando se arrastra algun elemento al sidebar se activa el modal de
                  DialogImportDB.
                </li>
                <li>Refactor: Alto fijo SearchItem</li>
                <li>Refactor: Modificación del icono de fijado y desfijado</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.1.0</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Refactor: Rearmado de archivos y limpieza de código.</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.21</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Refactor: Mejor interacción en mobile para el Sidebar.</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.20</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Feature: se agrega un Tour la primera vez que ingresas.</li>
                <li>
                  Refactor: Se modifica la posición y la jerarquia del boton Guardar documento.
                </li>
                <li>Refactor: Mas padding en mobile para el listado de documentos.</li>
                <li>Bump up dependencias</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.19</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Feature: Se agrega <code>async function change_project_fixed</code></li>
                <li>
                  Feature: Se agregan al estado global los ref <code>project_checked</code> y
                  <code>project_fixed</code>
                </li>
                ...
                <li>
                  Refactor: Nombre de la función <code>change_project_checked</code> reemplaza a
                  <code>mark_project_checked</code>.
                </li>
                <li>Refactor: Solo se puede hacer zoom a la imagen en modo previsualización.</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.18</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>
                  Refactor: El <code>shallowRef</code> del editor ahora se aloja en el store global.
                </li>
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.17</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Fix: dropdown en toolbar mal posicionada por el container querie</li>
                <li>Bump up dependencias</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.16</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.15</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Add: Se agrega iframe al editor.</li>
                <li>Refactor: Cleanup code DialogProjectListSearch.</li>
                <li>
                  Refactor: <code>ShikiCodeBlock</code> posicion del autocompletable y scroll arriba
                  del sombreado
                </li>
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.14</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Se revierte async editor.</li>
                <li>Mejor dialog para buscar con ctrl shift f.</li>
                <li>Editor por defecto en editable.</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.13</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>
                  Se agrega modo para previsualizar y que no sea editable (excepto la seleccion de
                  lenguaje de la terminal).
                </li>
                <li>
                  Reordenado visual. Importar y exportar solo se muestran con el menú abierto.
                </li>
                <li>
                  Busqueda de comando con <code>ctrl shift f</code> en modo previsualizar por ahora.
                </li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.12</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.11</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>
                  <span class="bg-primary py-0.5 px-1 rounded-full text-xs">Break</span> Se elimina
                  null por defecto en loaded_id y reemplaza por "".
                </li>
              ...
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.10</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Se accede al changelog desde el dialog de más información.</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.9</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Ahora los Check y Uncheck son dos arrays distintos</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.8</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Fix poder marcar Check/Uncheck al item cuando hay scroll</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">0.0.7</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
                <li>Se agrega la posibilidad de marcar un items como check.</li>
                <li>Se agrega ordenado de items por nombre o fecha</li>
              </ul>
              <h4 class="mt-3 mb-5 leading-normal text-foreground !select-text">Menor a 0.0.6</h4>
              <ul class="mt-2 mb-5 text-sm leading-normal text-foreground !select-text">
